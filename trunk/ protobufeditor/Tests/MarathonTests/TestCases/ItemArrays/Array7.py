...
def test():
	...
	if window('Protocol Buffer Editor'):
		...
		select('Table', 'cell:A,2(5.01)')
		select('Table', '5.0107896', 'A,2')
		select('Table', 'cell:A,0(19.0)')
		assert_p('Table', 'Content', '[[19.0], [-19.0], [5.0107896]]')
		select('Table', 'cell:A,2(5.0107896)')
		click('Add Row Before')
		assert_p('Table', 'Content', '[[19.0], [-19.0], [0.0], [5.0107896]]')
		select('Table', '0.04567', 'A,2')
		select('Table', 'cell:A,1(-19.0)')
		assert_p('Table', 'Content', '[[19.0], [-19.0], [0.04567], [5.0107896]]')
