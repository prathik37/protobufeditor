...
public class WriteLocations {
    ...
    private WriteLocations(String fname) {
        super();
        String installDir     =  "/home/bm/Programs/JRecord/SampleFiles/";
        String locationFile      = installDir + fname + ".txt";
        String locationFileOut   = "/home/bm/Work/Temp/" + fname + ".bin";
        String copybookName   = "/home/bm/Programs/JRecord/CopyBook/Cobol/" + "AmsLocation.cbl";
