...
public final class AmsLocation {
  ...
  public static final class Locations extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ams.AmsLocation.internal_static_ams_Locations_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return ams.AmsLocation.internal_static_ams_Locations_fieldAccessorTable;
    }
    ...
    public static ams.AmsLocation.Locations parseFrom(
    ...
    public static ams.AmsLocation.Locations parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static ams.AmsLocation.Locations parseFrom(
    ...
    public static ams.AmsLocation.Locations parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ams.AmsLocation.Locations parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeDelimitedFrom(input).buildParsed();
    }
    public static ams.AmsLocation.Locations parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(ams.AmsLocation.Locations prototype) {
    ...
    public static final class Builder extends
      ...
      private ams.AmsLocation.Locations result;
      
      // Construct using ams.AmsLocation.Locations.newBuilder()
      private Builder() {}
      
      private static Builder create() {
        Builder builder = new Builder();
        builder.result = new ams.AmsLocation.Locations();
        return builder;
      }
      
      protected ams.AmsLocation.Locations internalGetResult() {
        return result;
      }
      ...
      public Builder clear() {
        ...
        result = new ams.AmsLocation.Locations();
        return this;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return ams.AmsLocation.Locations.getDescriptor();
      }
      
      public ams.AmsLocation.Locations getDefaultInstanceForType() {
        return ams.AmsLocation.Locations.getDefaultInstance();
      }
      
      public boolean isInitialized() {
        return result.isInitialized();
      }
      public ams.AmsLocation.Locations build() {
      ...
      private ams.AmsLocation.Locations buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        if (!isInitialized()) {
      ...
      public ams.AmsLocation.Locations buildPartial() {
        if (result == null) {
          throw new IllegalStateException(
            "build() has already been called on this Builder.");
        }
        ams.AmsLocation.Locations returnMe = result;
        result = null;
        return returnMe;
      }
      
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ams.AmsLocation.Locations) {
          return mergeFrom((ams.AmsLocation.Locations)other);
        } else {
      ...
      public Builder mergeFrom(ams.AmsLocation.Locations other) {
        if (other == ams.AmsLocation.Locations.getDefaultInstance()) return this;
        if (other.hasBrandId()) {
  ...
  result.hasLocActvInd = true;
    ...
    static {
      ams.AmsLocation.getDescriptor();
    }
    
    static {
      ams.AmsLocation.internalForceInit();
    }
  }
  
  private static com.google.protobuf.Descriptors.Descriptor
    internal_static_ams_Locations_descriptor;
  private static
    com.google.protobuf.GeneratedMessage.FieldAccessorTable
      internal_static_ams_Locations_fieldAccessorTable;
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\022Ams_Location.proto\022\003ams\"\323\001\n\tLocations\022" +
      "\020\n\010Brand_Id\030\001 \002(\t\022\017\n\007Loc_Nbr\030\002 \002(\t\022\020\n\010Lo" +
      "c_Type\030\003 \002(\t\022\020\n\010Loc_Name\030\004 \002(\t\022\024\n\014Loc_Ad" +
      "dr_Ln1\030\005 \002(\t\022\024\n\014Loc_Addr_Ln2\030\006 \002(\t\022\024\n\014Lo" +
      "c_Addr_Ln3\030\007 \002(\t\022\024\n\014Loc_Postcode\030\010 \002(\t\022\021" +
      "\n\tLoc_State\030\t \002(\t\022\024\n\014Loc_Actv_Ind\030\n \002(\tB" +
      "\002H\001"
    };
    com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner assigner =
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_ams_Locations_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_ams_Locations_descriptor,
              new java.lang.String[] { "BrandId", "LocNbr", "LocType", "LocName", "LocAddrLn1", "LocAddrLn2", "LocAddrLn3", "LocPostcode", "LocState", "LocActvInd", },
              ams.AmsLocation.Locations.class,
              ams.AmsLocation.Locations.Builder.class);
          return null;
        }
      };
