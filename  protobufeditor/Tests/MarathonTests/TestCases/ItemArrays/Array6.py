...
def test():
	...
	if window('Protocol Buffer Editor'):
		...
		select('Table', '-19.0123', 'Data,1')
		select('Table', 'cell:Data,0(19.0)')
		assert_p('Table', 'Content', '[[0, 19.0], [1, -19.0123], [2, 5.01]]')
		select('Table', 'cell:Data,1(-19.0123)')
		click('Add Row After')
		assert_p('Table', 'Content', '[[0, 19.0], [1, -19.0123], [2, 0.0], [3, 5.01]]')
		select('Table', '0.0456', 'Data,2')
		select('Table', 'cell:Data,0(19.0)')
