...
def test():
	...
	if window('Protocol Buffer Editor'):
		...
		select('JTreeTable', 'cell:priceFloat,8([19.0, -19.0123, 456.012, 5.01])')
		click('ArrowButton')
		assert_p('Table', 'Content', '[[19.0], [-19.0123], [456.012], [5.01]]')
		select('Table', 'cell:A,3(5.01)')
		select('Table', '5.0123', 'A,3')
		select('Table', 'cell:A,2(456.012)')
		assert_p('Table', 'Content', '[[19.0], [-19.0123], [456.012], [5.0123]]')
