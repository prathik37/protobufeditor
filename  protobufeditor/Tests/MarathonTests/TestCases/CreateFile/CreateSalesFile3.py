...
def test():
	...
	if window('Protocol Buffer Editor'):
		select('FileChooser', commonBits.sampleDir() + 'zCcStore.bin')
...
##[[keycode, 1, , 0, 0], [store, 2, , 0, 0], [department, 3, , 0, 0], [saleDate, 4, , 0, 0], [quantity, 5, , 0, 0], [price, 6, , 0, 0]]')
		...
		select('Table', '33', 'Data,1')
		select('Table', '303', 'Data,2')
		select('Table', '30032003', 'Data,3')
		select('Table', '3', 'Data,4')
		select('Table', '33300', 'Data,5')
		select('Table', 'cell:Data,4(3)')
		click('Save1')
		click('BasicInternalFrameTitlePane$NoFocusButton2')
		select_menu('Window>>zCcStore.bin>>Table: ')
		select('Table', 'cell:2|store,0(222)')
		select('Table', 'cell:2|store,0(222)')
##		assert_p('Table', 'Content', '[[1111, 222, 3333, 445566, 1, 11000], [1212, 12, 12, 121212, 1, 12000], [321, 33, 303, 30032003, 3, 33300]]')
		assert_p('Table', 'Content', '[[1111, 222, 3333, 445566, 1, 11000], [321, 33, 303, 30032003, 3, 33300], [1212, 12, 12, 121212, 1, 12000]]')
		select('Table', 'cell:2|store,0(222)')
		click('BasicInternalFrameTitlePane$NoFocusButton2')
		click('Edit1')
...
##		assert_p('Table', 'Content', '[[1111, 222, 3333, 445566, 1, 11000], [1212, 12, 12, 121212, 1, 12000], [321, 33, 303, 30032003, 3, 33300]]')
		assert_p('Table', 'Content', '[[1111, 222, 3333, 445566, 1, 11000], [321, 33, 303, 30032003, 3, 33300], [1212, 12, 12, 121212, 1, 12000]]')
		select('Table', 'rows:[0,1,2],columns:[4|saleDate]')
		click('Delete2')
		click('Save1')
		click('BasicInternalFrameTitlePane$NoFocusButton2')

		os.remove(commonBits.sampleDir() + 'zCcStore.bin')
	close()
