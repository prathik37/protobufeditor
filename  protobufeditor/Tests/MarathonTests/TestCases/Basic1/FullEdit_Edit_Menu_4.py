...
def test():
	...
	if window('Protocol Buffer Editor'):
		...
		select('Table', 'cell:4|Loc_Name,4(St Marys)')
		assert_p('Table', 'RowCount', '13')
		select('Table', 'rows:[9,10,11],columns:[5|Loc_Addr_Ln1]')
		select_menu('Edit>>Delete Record#{s#}')
		select('Table', 'cell:3|Loc_Type,4(ST)')
		...
		select('Table', 'cell:4|Loc_Name,7(Miranda)')
		assert_p('Table', 'RowCount', '13')
		select('Table', 'cell:4|Loc_Name,7(Miranda)')
